...
class SimpleProductSerializer(serializers.ModelSerializer):
    class Meta:
        model = Product
        # field = ['id', 'title', 'unit_price'] 
        #defining feild will not work after 3.30 field is default to __all__
        exclude = ('slug', 'description', 'inventory','last_update', 'Collection', 'promotions')
